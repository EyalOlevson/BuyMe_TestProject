...
public class Report {
    ...
    public static void beforeClass() {
        ...
        ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("C:\\Eyal's Automation Projects\\---Reports---\\extent.html");
    ...
    public void test2_clickButton() throws IOException {
        ...
        // add screenshot
        test.pass("details", MediaEntityBuilder.createScreenCaptureFromPath(takeScreenShot("C:\\Eyal's Automation Projects\\---Reports---\\" + name.getMethodName())).build());
